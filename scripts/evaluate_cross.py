"""
Cross-Dataset Evaluation Script for GraphIDS (Original Model - No CL).
...
Usage:
    ...
    This loads the model trained on NB15-v3 and evaluates it on IDS2018-v3's test set.
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Cross-Dataset Evaluation for GraphIDS (Original Model)"
    )
    parser.add_argument(
    ...
    # Force BENIGN and NO FRACTION to get the standard schema
